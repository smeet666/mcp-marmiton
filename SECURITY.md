...
<https://github.com/smeet666/mcp-marmiton/security/advisories/new>. It reaches me
...
This server is a read-only client for Marmiton. It holds no credentials, needs no
API key, opens no port, and writes nothing back to Marmiton. That rules out most
of what a vulnerability report usually concerns.

What remains is worth reporting:

- **Anything that lets a caller reach a host other than Marmiton.** The URLs are
...
Rate limiting by Marmiton, or Marmiton being down, is the upstream's business and
